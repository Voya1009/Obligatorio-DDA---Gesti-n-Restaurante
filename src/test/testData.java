...
public class testData {
    ...
    public static void load(SystemFacade system) {
        ...
        system.addCategory(entradas);
        system.addCategory(principales);
        system.addCategory(bebidas);
        system.addCategory(postres);
